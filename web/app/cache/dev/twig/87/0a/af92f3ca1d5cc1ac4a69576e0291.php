...
class __TwigTemplate_870aaf92f3ca1d5cc1ac4a69576e0291 extends Twig_Template
{
    ...
    {
        // line 1
        echo "<div id=\"fc_Featured\"><a id=\"fc_FeaturedImages\" href=\"";
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("_accueil"), "html", null, true);
        echo "\"><img src=\"";
        echo twig_escape_filter($this->env, $this->env->getExtension('assets')->getAssetUrl("bundles/myappglobal/images/PhotoAccueil.jpg"), "html", null, true);
        echo "\" alt=\"Global Réservation\" width=\"1338\" height=\"1562\" /></a>
  \t<div id=\"fc_FeaturedTabs\">
\t\t<ul>
\t\t\t";
        // line 4
        if (($this->getAttribute($this->getAttribute($this->getContext($context, "app"), "request"), "locale") == "fr")) {
            // line 5
            echo "\t\t\t\t<li><a class=\"fc_Active\" href=\"";
...
\t</div>
    ...
    {
        return "MyAppGlobalBundle:Default:animation.html.twig";
    }
