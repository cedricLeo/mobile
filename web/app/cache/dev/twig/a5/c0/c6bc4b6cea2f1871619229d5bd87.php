...
/* MyAppGlobalBundle:Default:suggestionHotel-fr.html.twig */
class __TwigTemplate_a5c0c6bc4b6cea2f1871619229d5bd87 extends Twig_Template
{
    public function __construct(Twig_Environment $env)
    {
        ...
        $this->blocks = array(
            'suggestionHotel' => array($this, 'block_suggestionHotel'),
        );
    }
    ...
    {
        // line 1
        $this->displayBlock('suggestionHotel', $context, $blocks);
    }

    public function block_suggestionHotel($context, array $blocks = array())
    {
        // line 2
...
\t\t   ";
        ...
        $context['_seq'] = twig_ensure_traversable($this->getContext($context, "displayregionLeft1"));
        foreach ($context['_seq'] as $context["_key"] => $context["r1"]) {
            echo "\t\t   \t   
\t\t\t   <h2><a href=\"";
            // line 8
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("_hebergementtyperegionfr", array("name" => twig_lower_filter($this->env, $this->getAttribute($this->getContext($context, "categorie"), "repertoire_fr")), "region" => twig_lower_filter($this->env, $this->getAttribute($this->getContext($context, "r1"), "repertoirefr")))), "html", null, true);
            echo "\" title=\"Hôtel";
            if ((twig_length_filter($this->env, $this->getContext($context, "listClientGauche1")) > 1)) {
                echo "s";
            }
            echo " région ";
            echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "r1"), "nomfr"), "html", null, true);
            echo "\">Hôtel";
            if ((twig_length_filter($this->env, $this->getContext($context, "listClientGauche1")) > 1)) {
                echo "s";
            }
...
\t\t\t         ";
            // line 10
            $context['_parent'] = (array) $context;
            $context['_seq'] = twig_ensure_traversable($this->getContext($context, "listClientGauche1"));
            foreach ($context['_seq'] as $context["_key"] => $context["qc"]) {
                // line 11
                echo "\t\t\t           <li><a href=\"";
                echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("_hebergementinfoclient", array("name" => twig_lower_filter($this->env, $this->getAttribute($this->getContext($context, "qc"), "repertoirefr")))), "html", null, true);
                echo "\" target=\"_blank\" title=\"Hôtel ";
                echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "qc"), "nomfr"), "html", null, true);
                echo "\">";
                echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "qc"), "nomfr"), "html", null, true);
                echo "</a> ";
                if ((!twig_test_empty($this->getAttribute($this->getContext($context, "qc"), "prixapartir")))) {
                    echo " <span>";
                    echo twig_escape_filter($this->env, $this->env->getExtension('translator')->trans("a.partir"), "html", null, true);
                    echo " ";
                    echo twig_escape_filter($this->env, strtr($this->getAttribute($this->getContext($context, "qc"), "prixapartir"), array("\$" => "")), "html", null, true);
                    echo "\$</span>";
                }
                echo "</li>
\t\t\t         ";
...
\t\t\t   <h4>[<a href=\"";
            ...
            echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "r1"), "nomfr"), "html", null, true);
            echo "\" >Voir les hôtels région ";
            echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "r1"), "nomfr"), "html", null, true);
            echo "</a>]</h4>\t\t\t   
\t\t  ";
        }
        $_parent = $context['_parent'];
        unset($context['_seq'], $context['_iterated'], $context['_key'], $context['r1'], $context['_parent'], $context['loop']);
        $context = array_merge($_parent, array_intersect_key($context, $_parent));
        // line 16
        echo "\t\t</div>
\t\t
...
\t\t   ";
        // line 20
        $context['_parent'] = (array) $context;
        $context['_seq'] = twig_ensure_traversable($this->getContext($context, "displayregionLeft2"));
        foreach ($context['_seq'] as $context["_key"] => $context["r2"]) {
            echo "\t\t   \t  
\t\t\t   <h2><a href=\"";
            // line 21
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("_hebergementtyperegionfr", array("name" => twig_lower_filter($this->env, $this->getAttribute($this->getContext($context, "categorie"), "repertoire_fr")), "region" => twig_lower_filter($this->env, $this->getAttribute($this->getContext($context, "r2"), "repertoirefr")))), "html", null, true);
            echo "\" title=\"Hôtel";
            if ((twig_length_filter($this->env, $this->getContext($context, "listClientGauche2")) > 1)) {
                echo "s";
            }
            echo " région ";
            echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "r2"), "nomfr"), "html", null, true);
            echo "\">Hôtel";
            if ((twig_length_filter($this->env, $this->getContext($context, "listClientGauche2")) > 1)) {
                echo "s";
            }
...
\t\t\t         ";
            // line 23
            $context['_parent'] = (array) $context;
            $context['_seq'] = twig_ensure_traversable($this->getContext($context, "listClientGauche2"));
            foreach ($context['_seq'] as $context["_key"] => $context["qc"]) {
                // line 24
                echo "\t\t\t           <li><a href=\"";
                echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("_hebergementinfoclient", array("name" => twig_lower_filter($this->env, $this->getAttribute($this->getContext($context, "qc"), "repertoirefr")))), "html", null, true);
...
\t\t   ";
        // line 33
        $context['_parent'] = (array) $context;
        $context['_seq'] = twig_ensure_traversable($this->getContext($context, "displayregionLeft3"));
        foreach ($context['_seq'] as $context["_key"] => $context["r3"]) {
            echo "\t\t   \t  
\t\t\t   <h2><a href=\"";
            // line 34
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("_hebergementtyperegionfr", array("name" => twig_lower_filter($this->env, $this->getAttribute($this->getContext($context, "categorie"), "repertoire_fr")), "region" => twig_lower_filter($this->env, $this->getAttribute($this->getContext($context, "r3"), "repertoirefr")))), "html", null, true);
            echo "\" title=\"Hôtel";
            if ((twig_length_filter($this->env, $this->getContext($context, "listClientGauche3")) > 1)) {
                echo "s";
            }
            echo " région ";
            echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "r3"), "nomfr"), "html", null, true);
            echo "\">Hôtel";
            if ((twig_length_filter($this->env, $this->getContext($context, "listClientGauche3")) > 1)) {
                echo "s";
            }
...
\t\t\t         ";
            // line 36
            $context['_parent'] = (array) $context;
            $context['_seq'] = twig_ensure_traversable($this->getContext($context, "listClientGauche3"));
            foreach ($context['_seq'] as $context["_key"] => $context["qc"]) {
                // line 37
                echo "\t\t\t           <li><a href=\"";
                echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("_hebergementinfoclient", array("name" => twig_lower_filter($this->env, $this->getAttribute($this->getContext($context, "qc"), "repertoirefr")))), "html", null, true);
...
\t\t  ";
        ...
        $_parent = $context['_parent'];
        unset($context['_seq'], $context['_iterated'], $context['_key'], $context['r3'], $context['_parent'], $context['loop']);
        $context = array_merge($_parent, array_intersect_key($context, $_parent));
        // line 42
        echo "\t\t</div>
\t\t
...
\t\t   ";
        // line 46
        $context['_parent'] = (array) $context;
        $context['_seq'] = twig_ensure_traversable($this->getContext($context, "displayregionLeft4"));
        foreach ($context['_seq'] as $context["_key"] => $context["r4"]) {
            echo "\t\t   \t  
\t\t\t   <h2><a href=\"";
            // line 47
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("_hebergementtyperegionfr", array("name" => twig_lower_filter($this->env, $this->getAttribute($this->getContext($context, "categorie"), "repertoire_fr")), "region" => twig_lower_filter($this->env, $this->getAttribute($this->getContext($context, "r4"), "repertoirefr")))), "html", null, true);
            echo "\" title=\"Hôtel";
            if ((twig_length_filter($this->env, $this->getContext($context, "listClientGauche4")) > 1)) {
                echo "s";
            }
            echo " région ";
            echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "r4"), "nomfr"), "html", null, true);
            echo "\">Hôtel";
            if ((twig_length_filter($this->env, $this->getContext($context, "listClientGauche4")) > 1)) {
                echo "s";
            }
...
\t\t\t         ";
            // line 49
            $context['_parent'] = (array) $context;
            $context['_seq'] = twig_ensure_traversable($this->getContext($context, "listClientGauche4"));
            foreach ($context['_seq'] as $context["_key"] => $context["qc"]) {
                // line 50
                echo "\t\t\t           <li><a href=\"";
                echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("_hebergementinfoclient", array("name" => twig_lower_filter($this->env, $this->getAttribute($this->getContext($context, "qc"), "repertoirefr")))), "html", null, true);
...
\t\t  ";
        ...
        $_parent = $context['_parent'];
        unset($context['_seq'], $context['_iterated'], $context['_key'], $context['r4'], $context['_parent'], $context['loop']);
        $context = array_merge($_parent, array_intersect_key($context, $_parent));
        // line 55
        echo "\t\t</div>
\t   <br class=\"clearfloat\" />
